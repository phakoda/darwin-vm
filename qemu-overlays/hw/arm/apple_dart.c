 ...
 *
 * This models the T8020/T8030-style translation path needed by DMA-capable
 * Apple peripherals: stream TCR/TTBR programming, 4K/16K page-table walks,
 * bypass, permission checks, TLB invalidation, and fault reporting.
 *
